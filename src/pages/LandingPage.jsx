          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Convert customer wait times into a seamless experience. Boost efficiency, reduce frustration, and optimize your business facility's flow.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                ...
                to enhance customer flow and reduce wait times.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: -20 }}
...
const features = [
  ...
  },
  {
    ...
    description: 'Enhance customer experience with organized and efficient queuing.',
  },
];
